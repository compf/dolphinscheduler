...
public interface WorkflowInstanceMapper extends BaseMapper<WorkflowInstance> {
     ...
     * @param page                  page
     * @param workflowDefinitionCode workflowDefinitionCode
     * @param searchWorkflowInstance SearchWorkflowInstance object containing name, host, and other search parameters
     * @param startTime             startTime
     * @param endTime               endTime
     * @return workflow instance IPage
     */
    IPage<WorkflowInstance> queryWorkflowInstanceListV2Paging(Page<WorkflowInstance> page,
                                                              ...
                                                              @Param("searchParams") WorkflowInstanceSearchParams searchParams
     ...
     * @return ExecuteStatusCount list
     */
    List<ExecuteStatusCount> countInstanceStateV2(@Param("searchParams") WorkflowInstanceSearchParams searchParams);
                                                  @Param("startTime") Date startTime,
                                                  @Param("endTime") Date endTime,
                                                  @Param("projectCode") Long projectCode,
