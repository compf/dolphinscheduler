...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        Result result = projectParameterService.createProjectParameter(new ProjectParameterRequest(loginUser, "key", "value",
                DataType.VARCHAR.name()), projectCode);
        ...
        try (MockedStatic<CodeGenerateUtils> ignored = Mockito.mockStatic(CodeGenerateUtils.class)) {
            ...
            result = projectParameterService.createProjectParameter(new ProjectParameterRequest(loginUser, "key", "value",
                    DataType.VARCHAR.name()), projectCode);
        ...
        result = projectParameterService.createProjectParameter(new ProjectParameterRequest(loginUser, "key1", "value",
                DataType.VARCHAR.name()), projectCode);
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        Result result = projectParameterService.updateProjectParameter(new ProjectParameterRequest(loginUser, "key", "value",
                DataType.VARCHAR.name()), projectCode);
        assertNull(result.getData());
        assertNull(result.getCode());
        assertNull(result.getMsg());
        ...
        result = projectParameterService.updateProjectParameter(new ProjectParameterRequest(loginUser, "key", "value",
                DataType.VARCHAR.name()), projectCode);
        ...
        result = projectParameterService.updateProjectParameter(new ProjectParameterRequest(loginUser, "key1", "value",
                DataType.VARCHAR.name()), projectCode);
        ...
        when(projectParameterMapper.updateById(Mockito.any())).thenReturn(1);
        result = projectParameterService.updateProjectParameter(new ProjectParameterRequest(loginUser, "key1", "value",
                DataType.LONG.name()), projectCode, 1);
        assertEquals(Status.SUCCESS.getCode(), result.getCode());
    ...
    public void testQueryProjectParameterByCode() {
        ...
        Result result = projectParameterService.queryProjectParameterByCode(new ProjectParameterRequest(loginUser, projectCode, 1));
        assertNull(result.getData());
        assertNull(result.getCode());
        assertNull(result.getMsg());
        ...
        when(projectParameterMapper.queryByCode(Mockito.anyLong())).thenReturn(null);
        result = projectParameterService.queryProjectParameterByCode(new ProjectParameterRequest(loginUser, projectCode, 1));
        assertEquals(Status.PROJECT_PARAMETER_NOT_EXISTS.getCode(), result.getCode());
