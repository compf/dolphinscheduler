...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterRequest projectParameterRequest = new ProjectParameterRequest(loginUser, projectCode, "key", "value", DataType.VARCHAR);
        ...
        ProjectParameterRequest projectParameterRequest = new ProjectParameterRequest(loginUser, projectCode, "key1", "value", DataType.VARCHAR);
        result = projectParameterService.createProjectParameter(projectParameterRequest,
                DataType.VARCHAR.name());
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterUpdateRequest projectParameterUpdateRequest = new ProjectParameterUpdateRequest(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR);
        Result result = projectParameterService.updateProjectParameter(projectParameterUpdateRequest,
                DataType.VARCHAR.name());
        assertNull(result.getData());
        assertNull(result.getCode());
        assertNull(result.getMsg());
        ...
        ProjectParameterUpdateRequest projectParameterUpdateRequest = new ProjectParameterUpdateRequest(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR);
        result = projectParameterService.updateProjectParameter(projectParameterUpdateRequest,
                DataType.VARCHAR.name());
        ...
        ProjectParameterUpdateRequest projectParameterUpdateRequest = new ProjectParameterUpdateRequest(loginUser, projectCode, 1, "key1", "value", DataType.VARCHAR);
        result = projectParameterService.updateProjectParameter(projectParameterUpdateRequest,
                DataType.VARCHAR.name());
