...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterRequest request = new ProjectParameterRequest(loginUser, projectCode, "key", "value", DataType.VARCHAR);
        ...
        try (MockedStatic<CodeGenerateUtils> ignored = Mockito.mockStatic(CodeGenerateUtils.class)) {
            ...
            request = new ProjectParameterRequest(loginUser, projectCode, "key", "value", DataType.VARCHAR);
        ...
        request = new ProjectParameterRequest(loginUser, projectCode, "key1", "value", DataType.VARCHAR);
        result = projectParameterService.createProjectParameter(request);
                DataType.VARCHAR.name());
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterRequest request = new ProjectParameterRequest(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR);
        ...
        request = new ProjectParameterRequest(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR);
        ...
        request = new ProjectParameterRequest(loginUser, projectCode, 1, "key1", "value", DataType.VARCHAR);
        result = projectParameterService.updateProjectParameter(request);
                DataType.VARCHAR.name());
