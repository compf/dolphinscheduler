...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        // INSERT DATA ERROR
        ProjectParameterRequest request = new ProjectParameterRequest(loginUser, projectCode, "key1", "value", DataType.VARCHAR);
    ...
    public void testUpdateProjectParameter() {
        ...
        ProjectParameterRequest request = new ProjectParameterRequest(loginUser, projectCode, 1, "key1", "value", DataType.VARCHAR);
        when(projectParameterMapper.selectOne(Mockito.any())).thenReturn(null);
