...
public class ProjectParameterServiceTest {
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterInfo projectParameterInfo = new ProjectParameterInfo(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR);
        ...
        ProjectParameterInfo projectParameterInfo = new ProjectParameterInfo(loginUser, projectCode, 1, "key1", "value", DataType.VARCHAR);
        result = projectParameterService.updateProjectParameter(projectParameterInfo,
                DataType.VARCHAR.name());
