...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterCreation projectParameterCreation = new ProjectParameterCreation(loginUser, projectCode, "key", "value", "VARCHAR");
        ...
        ProjectParameterCreation projectParameterCreation = new ProjectParameterCreation(loginUser, projectCode, "key1", "value", "VARCHAR");
        result = projectParameterService.createProjectParameter(projectParameterCreation);
                DataType.VARCHAR.name());
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        ProjectParameterUpdate projectParameterUpdate = new ProjectParameterUpdate(loginUser, projectCode, 1, "key", "value", "VARCHAR");
        ...
        ProjectParameterUpdate projectParameterUpdate = new ProjectParameterUpdate(loginUser, projectCode, 1, "key1", "value", "VARCHAR");
        result = projectParameterService.updateProjectParameter(projectParameterUpdate);
                DataType.VARCHAR.name());
