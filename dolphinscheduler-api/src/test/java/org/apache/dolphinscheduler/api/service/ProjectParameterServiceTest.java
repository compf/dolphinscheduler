...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        Result result = projectParameterService.createProjectParameter(new ProjectParameterRequest("key", "value",
                DataType.VARCHAR.name()), loginUser, projectCode);
        ...
        try (MockedStatic<CodeGenerateUtils> ignored = Mockito.mockStatic(CodeGenerateUtils.class)) {
            ...
            result = projectParameterService.createProjectParameter(new ProjectParameterRequest("key", "value",
                    DataType.VARCHAR.name()), loginUser, projectCode);
        ...
        result = projectParameterService.createProjectParameter(new ProjectParameterRequest("key1", "value",
                DataType.VARCHAR.name()), loginUser, projectCode);
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        Result result = projectParameterService.updateProjectParameter(new ProjectParameterRequest("key", "value",
                DataType.VARCHAR.name()), loginUser, projectCode);
        assertNull(result.getData());
        assertNull(result.getCode());
        assertNull(result.getMsg());
        ...
        result = projectParameterService.updateProjectParameter(new ProjectParameterRequest("key", "value",
                DataType.VARCHAR.name()), loginUser, projectCode);
        ...
        result = projectParameterService.updateProjectParameter(new ProjectParameterRequest("key1", "value",
                DataType.VARCHAR.name()), loginUser, projectCode);
        ...
        when(projectParameterMapper.updateById(Mockito.any())).thenReturn(1);
        result = projectParameterService.updateProjectParameter(new ProjectParameterRequest("key1", "value",
                DataType.LONG.name()), loginUser, projectCode);
        assertEquals(Status.SUCCESS.getCode(), result.getCode());
