...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        parameterInfo = new ProjectParameterInfo("key", "value", DataType.VARCHAR.name());
        result = projectParameterService.createProjectParameter(loginUser, projectCode, parameterInfo);
        ...
        parameterInfo = new ProjectParameterInfo("key1", "value", DataType.VARCHAR.name());
        result = projectParameterService.createProjectParameter(loginUser, projectCode, parameterInfo);
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        // SUCCESS
        when(projectParameterMapper.updateById(Mockito.any())).thenReturn(1);
        parameterInfo = new ProjectParameterInfo("key1", "value", DataType.LONG.name());
        result = projectParameterService.updateProjectParameter(loginUser, projectCode, 1, parameterInfo);
        assertEquals(Status.SUCCESS.getCode(), result.getCode());
