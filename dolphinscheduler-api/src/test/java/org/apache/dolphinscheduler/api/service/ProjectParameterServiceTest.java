...
public class ProjectParameterServiceTest {
    ...
    public void testUpdateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class)))
                .thenReturn(false);
        Result result = projectParameterService.updateProjectParameter(new ProjectParameterUpdateRequest(loginUser, projectCode, 1, "key", "value",
                DataType.VARCHAR.name());
        assertNull(result.getData());
        assertNull(result.getCode());
        assertNull(result.getMsg());
        ...
        result = projectParameterService.updateProjectParameter(new ProjectParameterUpdateRequest(loginUser, projectCode, 1, "key", "value",
                DataType.VARCHAR.name());
        ...
        result = projectParameterService.updateProjectParameter(new ProjectParameterUpdateRequest(loginUser, projectCode, 1, "key1", "value",
                DataType.VARCHAR.name());
