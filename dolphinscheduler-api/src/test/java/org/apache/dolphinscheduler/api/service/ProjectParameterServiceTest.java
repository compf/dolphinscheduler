...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        parameterRequest = new ProjectParameterRequest(loginUser, projectCode, "key", "value", DataType.VARCHAR.name());
        result = projectParameterService.createProjectParameter(loginUser, projectCode, "key", "value", DataType.VARCHAR.name());
        ...
        parameterRequest = new ProjectParameterRequest(loginUser, projectCode, "key1", "value", DataType.VARCHAR.name());
        result = projectParameterService.createProjectParameter(loginUser, projectCode, "key", "value", DataType.VARCHAR.name());
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        parameterRequest = new ProjectParameterRequest(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR.name());
        ...
        parameterRequest = new ProjectParameterRequest(loginUser, projectCode, 1, "key1", "value", DataType.VARCHAR.name());
        result = projectParameterService.updateProjectParameter(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR.name());
        assertEquals(Status.UPDATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());

        // SUCCESS
        when(projectParameterMapper.updateById(Mockito.any())).thenReturn(1);
        parameterRequest = new ProjectParameterRequest(loginUser, projectCode, 1, "key1", "value", DataType.LONG.name());
        result = projectParameterService.updateProjectParameter(loginUser, projectCode, 1, "key", "value", DataType.VARCHAR.name());
        assertEquals(Status.SUCCESS.getCode(), result.getCode());
