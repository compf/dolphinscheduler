...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        when(projectService.hasProjectAndWritePerm(Mockito.any(), Mockito.any(), Mockito.any(Result.class))).thenReturn(false);
        ...
        request.setLoginUser(loginUser);
        request.setProjectCode(projectCode);
        request.setProjectParameterName("key1");
        request.setProjectParameterValue("value");
        request.setProjectParameterDataType(DataType.VARCHAR.name());
    ...
    public void testUpdateProjectParameter() {
        ...
        updateRequest.setProjectCode(projectCode);
        updateRequest.setCode(1L);
        updateRequest.setProjectParameterName("key1");
        updateRequest.setProjectParameterValue("value");
        updateRequest.setProjectParameterDataType(DataType.VARCHAR.name());
