...
public class ProjectParameterServiceTest {
    ...
    public void testCreateProjectParameter() {
        ...
        parameterInfo = new ProjectParameterInfo(loginUser, "key", "value", DataType.VARCHAR.name());
        ...
        parameterInfo = new ProjectParameterInfo(loginUser, "key1", "value", DataType.VARCHAR.name());
        result = projectParameterService.createProjectParameter(parameterInfo, projectCode);
        assertEquals(Status.CREATE_PROJECT_PARAMETER_ERROR.getCode(), result.getCode());
    ...
    public void testUpdateProjectParameter() {
        ...
        // SUCCESS
        when(projectParameterMapper.updateById(Mockito.any())).thenReturn(1);
        parameterInfo = new ProjectParameterInfo(loginUser, "key1", "value", DataType.LONG.name());
        result = projectParameterService.updateProjectParameter(parameterInfo, projectCode, 1);
        assertEquals(Status.SUCCESS.getCode(), result.getCode());
