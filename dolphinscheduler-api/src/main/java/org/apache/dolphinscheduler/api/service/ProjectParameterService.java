...
public interface ProjectParameterService {
    ...
    Result updateProjectParameter(ProjectParameterUpdateRequest parameterUpdateRequest);

    Result deleteProjectParametersByCode(ProjectParameterCodeRequest parameterCodeRequest);
