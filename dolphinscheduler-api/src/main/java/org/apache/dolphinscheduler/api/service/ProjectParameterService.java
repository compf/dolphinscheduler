...
public interface ProjectParameterService {
    ...
    Result createProjectParameter(ProjectParameterDetails projectParameterDetails);

    Result updateProjectParameter(ProjectParameterDetails projectParameterDetails,
