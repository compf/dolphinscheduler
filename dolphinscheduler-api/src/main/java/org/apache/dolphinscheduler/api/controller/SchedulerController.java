...
public class SchedulerController extends BaseController {
     ...
     * create schedule
     *
     * @param scheduleCreation schedule creation parameters
     ...
     *
     * @param scheduleUpdate schedule update parameters
     * @return update result code
     */
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(ScheduleUpdate scheduleUpdate)
                                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
