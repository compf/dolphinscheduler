...
public class SchedulerController extends BaseController {
    ...
    public Result createSchedule(ScheduleCreationParameters scheduleCreationParameters) {
        ...
        Map<String, Object> result = schedulerService.insertSchedule(scheduleCreationParameters);
                environmentCode);
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(ScheduleUpdateParameters scheduleUpdateParameters) {
                                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
                                                         ...
                                                         @RequestParam(value = "workerGroup", required = false, defaultValue = "default") String workerGroup,
                                                         @RequestParam(value = "tenantCode", required = false, defaultValue = "default") String tenantCode,
        Map<String, Object> result = schedulerService.updateScheduleByWorkflowDefinitionCode(scheduleUpdateParameters);
                environmentCode);
        return returnDataList(result);
    }
}
