...
public class SchedulerController extends BaseController {
     ...
     * create schedule
     *
     * @param scheduleRequest schedule request containing all necessary information
     ...
     *
     * @param scheduleUpdateRequest schedule update request containing all necessary information
     * @return update result code
     */
