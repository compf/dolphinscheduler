...
public class SchedulerController extends BaseController {
     ...
     * create schedule
     *
     * @param parameter ScheduleCreationParameter
    ...
    public Result createSchedule(@Parameter(hidden = true) @RequestAttribute(value = SESSION_USER) ScheduleCreationParameter creationParameter,
        ...
        Map<String, Object> result = schedulerService.insertSchedule(creationParameter,
                environmentCode);
     ...
     *
     * @param parameter ScheduleUpdateParameter
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(@Parameter(hidden = true) @RequestAttribute(value = SESSION_USER) ScheduleUpdateParameter updateParameter,
                                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
        ...
        Map<String, Object> result = schedulerService.updateScheduleByWorkflowDefinitionCode(updateParameter,
                environmentCode);
        return returnDataList(result);
    }
}
