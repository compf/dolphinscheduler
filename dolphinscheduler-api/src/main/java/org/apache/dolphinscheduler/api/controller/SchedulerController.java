...
public class SchedulerController extends BaseController {
    ...
    public Result createSchedule(@RequestBody ScheduleInfo scheduleInfo) {
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(@RequestBody ScheduleInfo scheduleInfo, @PathVariable(value = "code") long code) {
