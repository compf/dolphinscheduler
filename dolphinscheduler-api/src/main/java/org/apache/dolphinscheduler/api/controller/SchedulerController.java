...
public class SchedulerController extends BaseController {
    ...
    public Result createSchedule(@RequestBody CreateScheduleRequest createScheduleRequest) {
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(@RequestBody UpdateScheduleRequest updateScheduleRequest) {
