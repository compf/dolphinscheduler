...
public class SchedulerController extends BaseController {
    ...
    public Result createSchedule(@ModelAttribute ScheduleCreationRequest scheduleCreationRequest) {
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(@ModelAttribute ScheduleUpdateRequest scheduleUpdateRequest) {
                                                         @RequestParam(value = "environmentCode", required = false, defaultValue = "-1") long environmentCode,
