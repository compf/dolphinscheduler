...
public class SchedulerController extends BaseController {
    ...
    public Result createSchedule(ScheduleCreationParameters scheduleParameters) {
    ...
    @ApiException(UPDATE_SCHEDULE_ERROR)
    @OperatorLog(auditType = AuditType.SCHEDULE_UPDATE)
    public Result updateScheduleByWorkflowDefinitionCode(ScheduleUpdateParameters scheduleParameters) {
