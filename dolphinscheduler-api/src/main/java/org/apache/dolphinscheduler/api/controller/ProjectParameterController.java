...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(ProjectParameterParam projectParameterParam) {
    ...
    public Result updateProjectParameter(ProjectParameterUpdateParam projectParameterUpdateParam) {
