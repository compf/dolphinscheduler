...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(ProjectParameterCreation projectParameterCreation) {
    ...
    public Result updateProjectParameter(ProjectParameterUpdate projectParameterUpdate) {
                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
