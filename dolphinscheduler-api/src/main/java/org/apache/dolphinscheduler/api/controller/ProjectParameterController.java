...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(@RequestBody ProjectParameterInfo parameterInfo) {
    ...
    public Result updateProjectParameter(@RequestBody ProjectParameterUpdateInfo updateInfo) {
                                         return projectParameterService.updateProjectParameter(updateInfo);
