...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(@RequestBody ProjectParameterDetails details) {
    ...
    public Result updateProjectParameter(@RequestBody ProjectParameterDetails details) {
