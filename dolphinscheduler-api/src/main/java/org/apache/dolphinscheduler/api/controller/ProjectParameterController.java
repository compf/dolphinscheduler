...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(ProjectParameterDetails projectParameterDetails) {
                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
                                         @RequestParam("projectParameterName") String projectParameterName,
                                         return projectParameterService.createProjectParameter(projectParameterDetails);
    }
    ...
    public Result updateProjectParameter(ProjectParameterDetails projectParameterDetails) {
                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
                                         @PathVariable("code") Long code,
                                         @RequestParam("projectParameterName") String projectParameterName,
                                         return projectParameterService.updateProjectParameter(projectParameterDetails);
    }
