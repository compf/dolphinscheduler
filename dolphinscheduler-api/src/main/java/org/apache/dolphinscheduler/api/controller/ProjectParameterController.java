...
public class ProjectParameterController extends BaseController {
    ...
    public Result updateProjectParameter(ProjectParameterUpdateInfo projectParameterUpdateInfo) {
                                         @Parameter(name = "projectCode", description = "PROJECT_CODE", required = true) @PathVariable long projectCode,
                                         @PathVariable("code") Long code,
                                         @RequestParam("projectParameterName") String projectParameterName,
        return projectParameterService.updateProjectParameter(projectParameterUpdateInfo);
    }
