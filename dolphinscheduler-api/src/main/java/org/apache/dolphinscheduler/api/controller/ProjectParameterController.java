...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(@ModelAttribute ProjectParameterRequest parameterRequest) {
    ...
    public Result updateProjectParameter(@ModelAttribute ProjectParameterUpdateRequest parameterUpdateRequest) {
