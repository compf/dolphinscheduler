...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(ProjectParameterRequest parameterRequest,
        ...
        return projectParameterService.createProjectParameter(parameterRequest.getLoginUser(), parameterRequest.getProjectCode(), parameterRequest.getProjectParameterName(),
