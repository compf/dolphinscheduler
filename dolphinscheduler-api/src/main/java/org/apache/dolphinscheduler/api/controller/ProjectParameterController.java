...
public class ProjectParameterController extends BaseController {
    ...
    public Result createProjectParameter(@RequestBody ProjectParameterCreationParameters creationParameters) {
    ...
    public Result updateProjectParameter(@RequestBody ProjectParameterUpdateParameters updateParameters) {
