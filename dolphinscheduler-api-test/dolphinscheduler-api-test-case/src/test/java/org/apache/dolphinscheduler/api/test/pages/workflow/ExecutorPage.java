...
public class ExecutorPage {
    ...
    public HttpResponse execute(User loginUser, long projectCode, ExecutionRequest executionRequest) {
        Map<String, Object> params = new HashMap<>();
        params.put("loginUser", loginUser);
    ...
    public HttpResponse executeTask(User loginUser, long projectCode, ExecutionRequest executionRequest,
