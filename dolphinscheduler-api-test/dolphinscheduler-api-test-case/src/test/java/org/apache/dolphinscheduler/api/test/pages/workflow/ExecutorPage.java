...
public class ExecutorPage {
    ...
    public HttpResponse executeTask(TaskExecutionParameters taskExecutionParameters) {
        Map<String, Object> params = new HashMap<>();
        params.put("loginUser", taskExecutionParameters.getLoginUser());
        params.put("workflowInstanceId", taskExecutionParameters.getWorkflowInstanceId());
        params.put("startNodeList", taskExecutionParameters.getStartNodeList());
