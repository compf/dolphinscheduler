...
public class ExecutorPage {
    ...
    public HttpResponse execute(ExecutorParameter executorParameter) {
        Map<String, Object> params = new HashMap<>();
        params.put("loginUser", loginUser);
    ...
    public HttpResponse executeTask(ExecutorParameter executorParameter, String startNodeList,
